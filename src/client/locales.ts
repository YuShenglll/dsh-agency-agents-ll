...
const zh = {
  ...
  'prompt.locale.zh': '中文提示词',
  'prompt.locale.en': '英文提示词',
  'prompt.fallback': '这位专家只有英文提示词，已回退英文原文。',
...
const en = {
  ...
  'prompt.locale.zh': 'Chinese prompt',
  'prompt.locale.en': 'English prompt',
  'prompt.fallback': 'This expert has an English prompt only; the English original is served instead.',
